adsApp.factory("notification", ["$rootScope", "$timeout", "$sce", function ($rootScope, $timeout, $sce) {
    ...
    function displaySuccessMessage(message, timeout) { 
        return service.add("success", $sce.trustAsHtml(message), timeout);
    }
    
    function displayErrorMessage(message, serverError, timeout) {
        var errors = [];
