        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainmenu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li <?php if ('Logout' == $this->title) { echo 'class="active"'; } ?>><a href="<?php echo DX_ROOT_URL; ?>logout">Logout <?php if ('Logout' == $this->title) { echo '<span class="sr-only">(current)</span>'; } ?></a></li>
                    <li <?php if ('Login' == $this->title) { echo 'class="active"'; } ?>><a href="<?php echo DX_ROOT_URL; ?>login">Login <?php if ('Login' == $this->title) { echo '<span class="sr-only">(current)</span>'; } ?></a></li>
                    <li <?php if ('Register' == $this->title) { echo 'class="active"'; } ?>><a href="<?php echo DX_ROOT_URL; ?>register">Register <?php if ('Register' == $this->title) { echo '<span class="sr-only">(current)</span>'; } ?></a></li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
    </nav>
